...
export function createBottomTabs(scene, activeTab, onSelect) {
  ...
  GAME_TABS.forEach((tab, index) => {
    ...
    label.y = 26;
    const button = scene.add.container(x, y, [circle, label]).setSize(tabWidth, 78);
    button.setInteractive(new Phaser.Geom.Rectangle(-tabWidth / 2, -39, tabWidth, 78), Phaser.Geom.Rectangle.Contains);
